...
export const DEFAULT_TRANSLATION = {
	...
	'action-svb.add-from-edubreak': 'Add content from edubreak®',
	'action-svb.upload-content': 'Upload content',
	'action-svb.create-screen-recording': 'Create screen recording',
	'action-svb.import-media': 'Import media',
	'action-svb.share-board': 'Share board',
