...
export type TLTranslationKey =
	...
	| 'action-svb.add-from-edubreak'
	| 'action-svb.upload-content'
	| 'action-svb.create-screen-recording'
	| 'action-svb.import-media'
	| 'action-svb.share-board'
	| 'color-style.black'
	| 'color-style.blue'
	| 'color-style.green'
	| 'color-style.grey'
