...
import { ViewzoneLabelInput } from './ViewzoneLabelInput'

export const ViewzoneHeading = function ViewzoneHeading({
	id,
	name,
	width,
	height,
	...
	return (
		...
		>
			<div className="tl-viewzone-heading-hit-area">
				<ViewzoneLabelInput ref={rInput} id={id} name={name} isEditing={isEditing} />
			</div>
		</div>
	)
}
